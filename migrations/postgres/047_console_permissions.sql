...
ALTER TABLE console_users ADD COLUMN IF NOT EXISTS permission_set_id TEXT REFERENCES permission_sets(id);
...
ALTER TABLE console_users ADD COLUMN IF NOT EXISTS include_unscoped BOOLEAN NOT NULL DEFAULT FALSE;
