...
const POSTGRES_MIGRATIONS: &[(&str, &str)] = &[
    ...
    (
        "037_custody",
        include_str!("../../../../migrations/postgres/037_custody.sql"),
    ),
    (
        "038_repairs",
        include_str!("../../../../migrations/postgres/038_repairs.sql"),
    ),
    (
        "039_custody_loaner",
    ...
    (
        "045_quantity_items",
        include_str!("../../../../migrations/postgres/045_quantity_items.sql"),
    ),
    (
        "046_asset_reports",
        include_str!("../../../../migrations/postgres/046_asset_reports.sql"),
    ),
    (
    ...
    (
        "050_dashboard_shares",
        include_str!("../../../../migrations/postgres/050_dashboard_shares.sql"),
    ),
];
...
const SQLITE_MIGRATIONS: &[(&str, &str)] = &[
    ...
    (
        "037_custody.sql",
        include_str!("../../../../migrations/sqlite/037_custody.sql"),
    ),
    (
        "038_repairs.sql",
        include_str!("../../../../migrations/sqlite/038_repairs.sql"),
    ),
    (
    ...
    (
        "045_quantity_items.sql",
        include_str!("../../../../migrations/sqlite/045_quantity_items.sql"),
    ),
    (
        "046_asset_reports.sql",
        include_str!("../../../../migrations/sqlite/046_asset_reports.sql"),
    ),
    (
    ...
    (
        "050_dashboard_shares.sql",
        include_str!("../../../../migrations/sqlite/050_dashboard_shares.sql"),
    ),
];
